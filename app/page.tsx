...
function StatCard({ end, suffix, label }: { end: number; suffix: string; label: string }) {
    const { count, ref, displayValue } = useCounter(end, 2200, suffix);
    return (
                ...
                <div className="container-custom relative z-10">
                    <div ref={heroRef} className="max-w-4xl mx-auto text-center reveal">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                            <Link href="/signup" className="btn btn-primary text-base px-8 py-3.5 shadow-lg hover:shadow-glow">
                                Start Free
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                </svg>
                            </Link>
                            <Link href="/universities" className="btn btn-ghost text-base px-8 py-3.5">
                                Browse Universities
                            </Link>
                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                                    ...
                                    <div className="card-glass p-5 rounded-2xl">
                                        ...
                                        <div className="flex gap-1.5 mt-3">
                                            {['primary', 'accent', 'primary', 'surface'].map((c, i) => (
                                    ...
                                    <div className="flex items-end justify-between gap-3 h-32">
                                        {[40, 55, 70, 45, 85, 60, 90, 75, 95, 80, 70, 85].map((h, i) => (
                                            <div key={i} className="flex-1 flex gap-0.5 items-end">
                                                <div
                                                    className="flex-1 rounded-t-md bg-primary-500/70 transition-all duration-500"
                                                    style={{ height: `${h}%` }}
                                                />
                                                <div
                                                    className="flex-1 rounded-t-md bg-accent-500/70 transition-all duration-500"
                                                    style={{ height: `${Math.max(20, h - 15 + Math.random() * 20)}%` }}
                                                />
                                            </div>
                                        ))}
                                    </div>
                ...
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <FeatureCard
                            ...
                            description="AI-powered scores with full breakdown: 40% Academic, 30% Budget, 20% ROI, 10% Visa Risk."
                        ...
                        <FeatureCard
                            ...
                            description="Break-even analysis, loan simulations, and 5-year net gain projections for every university."
                        ...
                        <FeatureCard
                            ...
                            description="Browse real admit/reject data from students with similar profiles. Filter by CGPA, IELTS, and more."
                        ...
                        <FeatureCard
                            ...
                            description="Zero revenue from university referrals. We earn from users, not institutions. That's real alignment."
                ...
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
                        {[
                            ...
                            const ref = useReveal();
                            return (
                                <div key={idx} ref={ref} className={`reveal reveal-delay-${idx + 1} text-center group`}>
                                    ...
                                    <h3 className="text-lg font-semibold mb-2 tracking-tight" style={{ color: 'var(--text-primary)' }}>{item.title}</h3>
                ...
                <div className="container-custom relative z-10 text-center">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/signup" className="btn bg-white text-primary-700 hover:bg-surface-50 text-base px-8 py-3.5 shadow-xl hover:shadow-2xl font-semibold rounded-full">
                                Get Started — It&apos;s Free
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                </svg>
                            </Link>
                            <Link href="/transparency" className="btn border-2 border-white/30 text-white hover:bg-white/10 text-base px-8 py-3.5 rounded-full font-medium">
