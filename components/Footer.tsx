                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                { href: '/admits', label: 'Verified Admits' },
                                { href: '/dashboard', label: 'Dashboard' },
                            ].map(link => (
                                <li key={link.href}>
                                    <Link href={link.href} className="text-sm transition-colors duration-200 hover:text-primary-500" style={{ color: 'var(--text-tertiary)' }}>
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
